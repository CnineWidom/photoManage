                    ...
                    <div class="caseDetail_main">
                            ...
                            <div class="caseDetail_main_content" style="margin-top:10px;">
                                ...
                                <div class="caseDetail_main_content_pic uploadPicture_main_content_pic" style="margin-top:20px;">
                                    <!-- <img src="picture/pic (9).png" alt="" width="100%" height=auto> -->
                                ...
                                <form action="" class="uploadPicture_main_content_form" method="POST">
                                <div class="caseDetail_main_content_detail">
                                        <div class="pic_content_detail_introduction" style="width: 100%;border:none;padding-top: 0px">
                                                ...
                                                <input type="text" style="width:100%;margin-top:10px;height:25px;padding-left:5px;font-size:16px;color:rgb(39,39,39);padding-right:5px;box-sizing:border-box;
                                                
                                                border: 1px solid rgba(0, 0, 0, .3);
                                                ">      
                                                
                                                <h3 class='uploadpicture_main_title'>条件及关键词 &nbsp;&nbsp;&nbsp;<span>写入关键词，会对您进行相应的推荐</span></h3> 
                                                <input type="text" style="width:100%;margin-top:10px;height:25px;padding-left:5px;font-size:16px;color:rgb(39,39,39);padding-right:5px;box-sizing:border-box;
                                                
                                                border: 1px solid rgba(0, 0, 0, .3);
                                                ">

                                                <h3 class='uploadpicture_main_title'>描述 &nbsp;&nbsp;&nbsp;<span>示例：随着时间的推移观察生长的具有黄斑黑色素痣的82岁女性的眼底照片。</span></h3> 
                                                <textarea type="text" style="width:100%;margin-top:10px;height:75px;padding-left:5px;font-size:16px;color:rgb(39,39,39);padding-right:5px;box-sizing:border-box;
                                                
                                                border: 1px solid rgba(0, 0, 0, .3);resize: none
                                                "></textarea>

                                                <h3 class='uploadpicture_main_title'>合作者 &nbsp;&nbsp;&nbsp;<span>示例：John Smith, University of Minnesota, Delaware Street Clinic</span></h3> 
                                                <input type="text" style="width:100%;margin-top:10px;height:25px;padding-left:5px;font-size:16px;color:rgb(39,39,39);padding-right:5px;box-sizing:border-box;
                                                ...
                                                <h3 class='uploadpicture_main_title'>成像设备 &nbsp;&nbsp;&nbsp;<span>示例：Heidelberg Spectralis 或 Zeiss FF4</span></h3> 
                                                <input type="text" style="width:100%;margin-top:10px;height:25px;padding-left:5px;font-size:16px;color:rgb(39,39,39);padding-right:5px;box-sizing:border-box;
                                                ...
                                                <a href="./uploadPictureSuccess.html"> <button class="share_button" type="button" style="margin-top:30px;">上传案例</button></a>
