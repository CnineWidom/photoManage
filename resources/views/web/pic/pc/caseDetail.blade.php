    ...
    <div style="width:100%;background:rgb(250,250,250);display:inline-block;">
        <div class="layout">
            <div class="caseDetail_main_conment">
                <form action="/detail/up" method="post" style="position:relative">
                    {{ csrf_field() }}
                    <h3>评论：</h3>
                    <input type="hidden" value="0" name='star' class='ratenum'/>
                    <textarea name="recode" id=""  placeholder="写下你的想法吧..."></textarea>
